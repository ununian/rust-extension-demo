...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_cubic_root_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_cubic_root_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:component:cubic-root:cubic-root:encoded world"]
#[doc(hidden)]
...
\0\x04\x01\x1fcomponent:cubic-root/cubic-root\x04\0\x0b\x10\x01\0\x0acubic-root\x03\
