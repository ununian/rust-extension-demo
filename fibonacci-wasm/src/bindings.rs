...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_fibonacci_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_fibonacci_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:component:fibonacci:fibonacci:encoded world"]
#[doc(hidden)]
...
\0\x04\x01\x1dcomponent:fibonacci/fibonacci\x04\0\x0b\x0f\x01\0\x09fibonacci\x03\
